...
/***/ function(module, exports, __webpack_require__) {
	...
	var _example = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Example = (function (_Component) {
	  ...
	  _createClass(Example, [{
	    ...
	    key: 'handleOnClose',
	    value: function handleOnClose(name) {
	      this.setState(_defineProperty({}, name, { isOpen: false }));
	      console.log("close");
	    }
	  }, {
	    key: 'render',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('i', { className: this.state.menu1.isOpen ? "fa fa-times" : "fa fa-bars" })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('i', { className: this.state.menu2.isOpen ? "fa fa-times" : "fa fa-bars" })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('i', { className: this.state.menu3.isOpen ? "fa fa-times" : "fa fa-bars" })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('i', { className: this.state.menu4.isOpen ? "fa fa-times" : "fa fa-bars" })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	...
	var Menu = (function (_Component) {
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function _getItems() {
	      ...
	      var items = [_react2.default.createElement(_button2.default, {
	        ref: 'button',
	        ...
	        x: x,
	        y: y,
	        key: "button" }, button.props.children)];
	      for (var i = 0; i < this.state.itemNumber && i < children.length; i += 1) {
	        items.push(_react2.default.createElement(_item2.default, {
	          ...
	          y: direction === "vertical" ? i * distance + y : y }, children[i].props.children));
	      }
	      return items;
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('div', null, this._getItems());
	    }
	  }]);
	...
	var Item = (function (_Component) {
	  ...
	  _createClass(Item, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(_reactMotion.Motion, { style: this.params[this.state.sequence] }, function (_ref) {
	        var scaleX = _ref.scaleX;
	        var scaleY = _ref.scaleY;
	        var x = _ref.x;
	        var y = _ref.y;
	        return _react2.default.createElement('div', { className: customClass,
